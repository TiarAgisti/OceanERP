...
#Region "Function Bank"
    ...
    Sub PropertiesGridBank()
        ...
        dgvBank.Columns(3).HeaderText = "Swift Code"
        dgvBank.Columns(3).Width = 200
        dgvBank.Columns(4).Visible = False
        dgvBank.Columns(5).Visible = False
...
#Region "Function Curr"
    ...
    Function SetCurrModel() As CurrencyModel
        ...
        Select Case displayCurr
            Case "Create"
                ...
                currModel.CurrencyCode = txtCurrCode.Text
    ...
    Sub InsertCurr()
        ...
        Try
            If currBFC.GetValidateCurrencyCode(txtCurrCode.Text) = True Then
