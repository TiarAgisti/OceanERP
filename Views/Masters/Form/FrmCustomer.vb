...
#Region "Function"
    ...
    End Sub
    Sub ListCustomer(myOptions As String, myParam As String)
        Try
    ...
    Sub DeleteCustomer()
        Dim vendorBFC As ClsVendor = New ClsVendor
        Dim logBFC As ClsLogHistory = New ClsLogHistory
        Dim logDesc As String = "Update Customer for Code = " + txtCode.Text + ",update IsActive = False"
        display = "Delete"
        Try
            If vendorBFC.UpdateVendor(SetModel, logBFC.SetLogHistory(logDesc), display) = True Then
                MsgBoxDeleted()
    ...
    Sub PreCreateDisplay()
        CheckPermissions()
        ClearText()
        ListCustomer(cmbCari.Text, txtCari.Text)
